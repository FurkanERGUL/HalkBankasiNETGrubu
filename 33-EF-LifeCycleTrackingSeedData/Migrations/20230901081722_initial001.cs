    ...
    public partial class initial001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "Furkan", "ERGÜL" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "AuthorId", "Biography", "FirstName", "LastName" },
                values: new object[] { 2, null, "FF", "loser" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "İntihar Mektuplarım" },
                    { 2, 2, "Kaybolmuş Anahtarlar" },
                    { 3, 2, "Şehrin En Güzel Manzarası" },
                    { 4, 1, "Delinin Gözyaşları" },
                    { 5, 1, "Kargalar" }
                });

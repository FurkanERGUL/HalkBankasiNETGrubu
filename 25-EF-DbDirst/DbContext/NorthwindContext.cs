...
using _25_EF_DbDirst.Models;

namespace _25_EF_DbDirst.DbContext
{
    public partial class NorthwindContext : Microsoft.EntityFrameworkCore.DbContext
    {
        ...
        public virtual DbSet<CustomerOrderSum> CustomerOrderSums { get; set; } = null!;
        public virtual DbSet<Employee> Employees { get; set; } = null!;
        public virtual DbSet<Invoice> Invoices { get; set; } = null!;
        public virtual DbSet<KimdenKime> KimdenKimes { get; set; } = null!;
        ...
        public virtual DbSet<UrunVeDetay> UrunVeDetays { get; set; } = null!;
        public virtual DbSet<VwCustomerTotal> VwCustomerTotals { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=KDK-403-YZ-PC11;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerOrderSum>(entity =>
            {
                ...
                entity.ToView("CustomerOrderSum");
            ...
            modelBuilder.Entity<KimdenKime>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("KimdenKime");
            ...
            modelBuilder.Entity<UrunVeDetay>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("UrunVeDetay");

                entity.Property(e => e.ProductId).HasColumnName("ProductID");

                entity.Property(e => e.ProductName).HasMaxLength(40);

                entity.Property(e => e.ToplamSiparişAdedi).HasColumnName("Toplam sipariş adedi");
            });

            modelBuilder.Entity<VwCustomerTotal>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_CustomerTotal");
